---
{"dg-publish":true,"permalink":"/publish/magia/sistema-de-combustivel-magico/"}
---


Todo uso de magia possui duplo custo:
1. **Custo Universal:** Combustível invisível ([[cosmologia/magi\|magi]]) que precisa de recuperação
2. **Custo Temático:** Efeito colateral relacionado à escola usada

### Combustível Invisível - [[cosmologia/magi\|Magi]]

**Conceito:**
- Todo conjurador possui reserva limitada de energia mágica ([[cosmologia/magi\|magi]])
...
**Analogia:** Assim como uma arma de fogo precisa de munição, magia precisa de [[cosmologia/magi\|magi]]. Puxar o gatilho sem balas não faz nada - forçar magia sem [[cosmologia/magi\|magi]] destrói o conjurador.
...
1. **Conexão Conceitual (não necessariamente oposto)**
   - [[escolas/umbra\|Umbra]] (cegar outro) → distorção da própria visão (mexer com percepção alheia afeta a sua)
   - [[escolas/hypno\|Hypno]] (exaurir outro) → exaustão própria (efeito espelhado - drena ambos)
   - [[escolas/phobos\|Phobos]] (causar medo) → ver aparições (medo "vaza" de volta para o usuário)
   - [[escolas/aegis\|Aegis]] (proteção física) → vulnerabilidade espiritual (balanceamento: ganho em uma área, perda em outra)
   - [[escolas/salvo\|Salvo]] (curar outro) → sentir a dor curada (transferência empática do sofrimento)
...
**Exemplo:**
- Iniciante usa [[escolas/umbra\|Umbra]] → distorção visual por 60 segundos
- Mestre usa [[escolas/umbra\|Umbra]] → distorção visual por 20 segundos
