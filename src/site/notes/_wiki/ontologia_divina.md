---
{"dg-publish":true,"permalink":"/wiki/ontologia-divina/"}
---
...
A relação entre mortais e deuses assume formas radicalmente distintas conforme a categoria divina. Apenas duas categorias estabelecem vínculos diretos e formais com mortais: [[_wiki/diabos\|diabos]], por meio de **contratos** ([[_wiki/pactum_diaboli\|Pactum Diaboli]]), e [[_wiki/demonios\|demônios]], por meio de **vínculos de força** ([[_wiki/vinculum_daemonis\|Vinculum Daemonis]]). Ambos os sistemas envolvem marcas físicas indeléveis, obrigações permanentes e custos que não podem ser revertidos. São os únicos dois sistemas em que a entidade divina exerce influência coercitiva sobre o mortal, e os únicos em que o mortal pode ser chamado, com propriedade, de "pactuado".

As demais categorias operam por mecanismos distintos que não constituem pactos. [[_wiki/titas\|Titãs]] relacionam-se com mortais por **simbiose** ([[_wiki/symbiosis_naturae\|Symbiosis Naturae]]): uma conexão viva e recíproca com espíritos naturais, que se desfaz caso o equilíbrio seja violado. [[_wiki/anjos\|Anjos]] concedem poder por **fé** ([[_wiki/devotio_sancta\|Devotio Sancta]]): a devoção genuína é o canal, e o poder flui proporcionalmente à sinceridade da crença. [[_wiki/siderais\|Siderais]] exigem **disciplina mental** ([[_wiki/meditatio_aetheris\|Meditatio Aetheris]]): décadas de treino meditativo para estabelecer contato com entidades de pura consciência. Nos três casos, o mortal não é "pactuado" porque não há contrato, vínculo de força nem obrigação imposta. A conexão pode ser interrompida por ambas as partes, e a recuperação após ruptura é possível, embora custosa.

Essa distinção é crucial para a compreensão de artefatos como a [[_wiki/fendris\|Fendris]], que rejeitam "mãos pactuadas": o termo refere-se exclusivamente a mortais vinculados por [[_wiki/pactum_diaboli\|Pactum Diaboli]] ou [[_wiki/vinculum_daemonis\|Vinculum Daemonis]]. Um [[_wiki/alvarar\|álvarar]] devoto de [[_wiki/azazel\|Azazel]], um druida em simbiose com [[_wiki/morlgrund\|Morlgrund]] ou um [[_wiki/frenim\|frenim]] treinado por [[_wiki/siderais\|siderais]] não são pactuados e não sofrem a restrição.

Pactos entre mortais e [[_wiki/diabos\|diabos]] são registrados em três níveis simultâneos:
...
- **[[_wiki/titas\|Titãs]] (verdes)** — Localização: Periferia do plano material (os mais próximos) | Interesse em [[_wiki/thamakard\|Thamakard]]: Alto — sentem as dores do plano, querem equilíbrio, consideram [[_wiki/thamakard\|Thamakard]] "casa deles"
- **[[_wiki/siderais\|Siderais]] (azuis)** — Localização: Vagam pelo [[_wiki/plano_etereo\|Plano Etéreo]] (distância variável) | Interesse em [[_wiki/thamakard\|Thamakard]]: Curiosidade, estudo, interesse intelectual. Sem julgamento moral
- **[[_wiki/anjos\|Anjos]] (brancos)** — Localização: Planos distantes próprios | Interesse em [[_wiki/thamakard\|Thamakard]]: Justiça e ordem. Exercem influência por fé, não por imposição direta
- **[[_wiki/diabos\|Diabos]] (negros)** — Localização: Planos distantes próprios | Interesse em [[_wiki/thamakard\|Thamakard]]: Controle, ordem sombria, domínio de almas. Atuam por contrato
- **[[_wiki/demonios\|Demônios]] (vermelhos)** — Localização: Planos distantes próprios | Interesse em [[_wiki/thamakard\|Thamakard]]: Destruição, caos, prazer na violência. Atuam por vínculo de força
