---
{"dg-publish":true,"permalink":"/wiki/justiciars/"}
---
...
A escolha de **[[_wiki/orum-rahru\|Orum-Rahru]]** como primeiro Justiciar foi calculada:
...
- [[_wiki/templarios\|Templários]] clássicos **extintos como instituição militar**
- Termo "templário" sobreviveu apenas para **sacerdotes subordinados** ([[_wiki/ophideias\|ophideias]], feiticeiros, necromantes dos templos)
- **Tensão permanente** entre Justiciars (braço [[_wiki/shadar\|shadar]]) e estruturas religiosas [[_wiki/drul\|druls]]
- Sistema projetado para **isolar influência subterrânea** da administração imperial

### Seleção e Ordenação

Não há nascimento que garanta o manto negro. A seleção ocorre exclusivamente entre [[_wiki/shadar\|Shadars]] que demonstraram excelência em três pilares: domínio marcial e arcano, erudição jurídica e devoção inquestionável ao culto. Veteranos de guerra são preferidos, pois compreendem visceralmente que a ordem exige dentes.

#### Cerimônia de Unção

Conduzida no [[_wiki/templo_de_azkaroth\|Templo de Azkaroth]]. O candidato ajoelha-se diante da [[_wiki/efigie_de_arothistar\|efígie de Arothistar]] e recebe três símbolos de autoridade:
...
Justiciars usam [[_wiki/teru\|Teru]] (10 escolas pretas), com ênfase operacional em:

- **[[_wiki/necro\|Necro]]:** Extração de verdades de mortos e moribundos
- **[[_wiki/nomos\|Nomos]]:** Contenção e aprisionamento
- **[[_wiki/anatho\|Anatho]]:** Maldições punitivas e marcas permanentes
...
- [[_wiki/orum-rahru\|Orum]] encontra serenidade na certeza inflexível da lei
