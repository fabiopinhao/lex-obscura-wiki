---
{"dg-publish":true,"permalink":"/wiki/magi/"}
---


### Natureza

Magi é a energia mágica universal que permeia [[_wiki/thamakard\|Thamakard]]. Funciona como combustível invisível de toda magia, independentemente do sistema de acesso utilizado. Cada conjurador possui uma reserva limitada de magi que precisa ser recuperada após uso. Tentar conjurar com reserva vazia resulta em sobrecarga, causando dano severo ou morte.

Segundo a [[_wiki/teoria_materialista\|Teoria Materialista]] de [[_wiki/jospin_valheorn\|Jospin Valheorn]], o magi é uma força alquímica real e invisível, uma matriz energética sutil. [[_wiki/jospin_valheorn\|Jospin]] definia deuses pela abundância de magi que possuíam, não por status espiritual, e considerava a alquimia a única forma consciente e autônoma de manipulação dessa força. A teoria foi adotada oficialmente pelo [[_wiki/imperio_sombrio\|Império Sombrio]], embora cópias dos tratados de [[_wiki/jospin_valheorn\|Jospin]] tenham sido destruídas ou proibidas em vários reinos.

A posição oposta é a [[_wiki/doutrina_da_alma\|Doutrina da Alma]], de [[_wiki/naiu_wula\|Naiu'Wula]], que ensina que toda magia nasce da alma e que magi é apenas "rastro da alma no mundo, não sua chama."
...
Apenas duas escolas de magia manipulam diretamente o [[_wiki/plano_etereo\|Plano Etéreo]]: [[_wiki/cosmo\|Cosmo]] (UB) e [[_wiki/spectro\|Spectro]] (BU). Ambas compartilham as cores azul e preto, mas com impacto invertido: em [[_wiki/cosmo\|Cosmo]], o componente azul (etéreo, intelectual) predomina; em [[_wiki/spectro\|Spectro]], o componente preto (sombrio, espectral) predomina.

O [[_wiki/flux_aetheria\|Flux Aetheria]] é a tentativa de manipular diretamente os condutos do [[_wiki/plano_etereo\|Plano Etéreo]]. Não constitui escola formal — é aplicação avançada de [[_wiki/cosmo\|Cosmo]] e [[_wiki/spectro\|Spectro]], extremamente perigosa e instável. A maioria dos acidentes mágicos catastróficos registrados na história envolve falhas no controle do canal magi.
