---
{"dg-publish":true,"permalink":"/wiki/aquilar/"}
---
...
Altura de 1,85m a 2,20m eretos. Porte que rivaliza com [[_wiki/draconideo\|draconídeos]] em envergadura, mas não em massa: a construção aquilar é aerodinâmica, ossos ocos reforçados por cartilagem densa, musculatura peitoral sobredimensionada para sustentar voo. Mais leves do que o porte sugere, a estrutura oca é vantagem no ar e fragilidade no chão: impactos pesados que um [[_wiki/orc\|orc]] absorveria quebram ossos aquilars.
...
Subjugação. Aquilars sob domínio imperial são cidadãos de segunda classe quando tolerados, prisioneiros quando úteis e exemplos quando convenientes. A cor branca os marca como antagônicos à base cromática do [[_wiki/culto_sombrio\|Culto Sombrio]] (preto e vermelho), e a hostilidade não é apenas política: há componente instintivo, sutil, na aversão que [[_wiki/shadar\|shadars]] sentem por raças alinhadas ao branco. Não chega a ser repulsa fisiológica, mas tempera cada interação com uma camada de desconfiança que a lógica não dissolve.
...
O [[_wiki/imperio_sombrio\|Império]] emprega métodos escalonados para neutralizar o voo aquilar. O método varia conforme contexto, urgência e grau de brutalidade que a situação autoriza.

**Mutilação física.** Tendões das asas cortados ou ossos alares quebrados. Permanente, visível, aplicada a prisioneiros de guerra e exemplos públicos. [[_wiki/auren\|Auren]] provavelmente sofreu este método.

**Grilhões arcanos.** Contenção mágica removível aplicada às asas, similar às correntes de [[_wiki/thrax\|Thrax]]. Para aquilars em custódia temporária ou cujas habilidades o [[_wiki/imperio_sombrio\|Império]] deseja preservar com opção de reativação.

**Selo de [[_wiki/nomos\|Nomos]].** Magia que paralisa a musculatura alar sem dano físico visível. Crueldade burocrática, limpa, aplicável em massa à população civil de territórios conquistados. O aquilar sente as asas, move as penas, mas o comando neural que inicia o voo simplesmente não chega. Reversível em teoria; na prática, nenhum oficial imperial desfez um selo de [[_wiki/nomos\|Nomos]] voluntariamente.
...
A variedade de métodos não é redundância: é gramática. Cada forma de cortar o voo comunica mensagem diferente, e o [[_wiki/imperio_sombrio\|Império]] escolhe a frase conforme o interlocutor.
...
**Contraste:** [[_wiki/shadar\|Shadars]] cortam com frieza, [[_wiki/drul\|druls]] envenenam com polidez, [[_wiki/draconideo\|draconídeos]] declaram, [[_wiki/orc\|orcs]] vão direto. Aquilars **recordam**. Cada frase é vista aérea de algo que já se foi.

### Conflitos Internos

**A fé e a mutilação.** Se a marca angelical é bênção, por que os [[_wiki/anjos\|anjos]] permitem a mutilação? A pergunta corrompe a *[[_wiki/devotio_sancta\|Devotio Sancta]]* por dentro: a fé exige pureza de intenção, e a dúvida é impureza. Aquilars que questionam perdem acesso mágico, o que confirma a dúvida, o que aprofunda a perda. O ciclo é teológico e fisiológico ao mesmo tempo.
