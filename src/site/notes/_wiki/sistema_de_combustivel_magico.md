---
{"dg-publish":true,"permalink":"/wiki/sistema-de-combustivel-magico/"}
---


Todo uso de magia possui duplo custo:
1. **Custo Universal:** Combustível invisível ([[_wiki/magi\|magi]]) que precisa de recuperação
2. **Custo Temático:** Efeito colateral relacionado à escola usada

### Combustível Invisível - [[_wiki/magi\|Magi]]

**Conceito:**
- Todo conjurador possui reserva limitada de energia mágica ([[_wiki/magi\|magi]])
...
**Analogia:** Assim como uma arma de fogo precisa de munição, magia precisa de [[_wiki/magi\|magi]]. Puxar o gatilho sem balas não faz nada - forçar magia sem [[_wiki/magi\|magi]] destrói o conjurador.
...
1. **Conexão Conceitual (não necessariamente oposto)**
   - [[_wiki/umbra\|Umbra]] (cegar outro) → distorção da própria visão (mexer com percepção alheia afeta a sua)
   - [[_wiki/hypno\|Hypno]] (exaurir outro) → exaustão própria (efeito espelhado - drena ambos)
   - [[_wiki/phobos\|Phobos]] (causar medo) → ver aparições (medo "vaza" de volta para o usuário)
   - [[_wiki/aegis\|Aegis]] (proteção física) → vulnerabilidade espiritual (balanceamento: ganho em uma área, perda em outra)
   - [[_wiki/salvo\|Salvo]] (curar outro) → sentir a dor curada (transferência empática do sofrimento)
...
**Exemplo:**
- Iniciante usa [[_wiki/umbra\|Umbra]] → distorção visual por 60 segundos
- Mestre usa [[_wiki/umbra\|Umbra]] → distorção visual por 20 segundos
