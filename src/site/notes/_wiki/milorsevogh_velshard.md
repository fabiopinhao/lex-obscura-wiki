---
{"dg-publish":true,"permalink":"/wiki/milorsevogh-velshard/"}
---
...
**Amostra 1** (ao ameaçar druidas de [[_wiki/thal_serin\|Thal'Serin]] com mensagem escrita): *"Se falarem verdade, serei justo. Se mentirem... saberei."* — seis palavras para onde outro Justiciar precisaria de seis parágrafos.

**Amostra 2** (reflexão diante do espelho sobre [[_wiki/merari_d_khunvel\|Merari]] ausente): *"Que espécie de lorde ignora a chegada de um juiz?"* — acusação formulada como pergunta, sem destinatário.

**Amostra 3** (ao instruite [[_wiki/ravhor\|Ravhor]] sobre a marca de [[_wiki/anatho\|Anatho]]): *"Se a marca despertar, lembra-te de [[_wiki/valdris\|Valdris]]. E faz o que deve ser feito."* — ordem sem drama, peso inteiramente transferido ao ouvinte.

**Amostra 4** (observação tática sobre [[_wiki/grothar\|Grothar]]): *"Numa torre, todo chão é borda."* — aforismo comprimido, uso do espaço como metáfora de poder.
