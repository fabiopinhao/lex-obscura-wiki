---
{"dg-publish":true,"permalink":"/wiki/ophideias/"}
---
...
A maioria das ophideias opera com magia preta via [[_wiki/pactum_diaboli\|Pactum Diaboli]], especializando-se em escolas compatíveis com espionagem:

**[[_wiki/spectro\|Spectro]] (BU):** Escola primária. Permite atravessar matéria, projeção espectral (sondagem de corpos e espaços), invisibilidade parcial. [[_wiki/syndrith_morghast\|Syndrith]] é especialista, sua sondagem no celeiro de [[_wiki/niedellin\|Niedellin]] (forma [[_wiki/spectro\|Spectro]] atravessando paredes, catalogando corpos adormecidos) exemplifica a aplicação operacional.

**[[_wiki/umbra\|Umbra]] (B):** Manipulação de sombras. Invocação de [[_wiki/ulravaeth\|Ulravaeth]]: inclinar-se e pronunciar o nome; a sombra projeta-se em "contravento espectral", pode indicar direções ou realizar gestos independentes.

**Língua ritual:** [[_wiki/gholvyss\|Gholvyss]]: língua diabólica matriarcal, extremamente secreta, reservada às ophideias fluentes. Distinta do [[_wiki/tenebraico\|Tenebraico]] comum. Usada em invocações que exigem conexão com [[_wiki/diabos\|diabos]] do panteão matriarcal [[_wiki/drul\|drul]].

### Estrutura Hierárquica e Lealdade

As ophideias não possuem hierarquia militar formal. A estrutura é religiosa: respondem às matriarcas das Casas (Duskryn, Morghast) e aos templos que as empregam ([[_wiki/azkaroth\|Azkaroth]] em [[_wiki/morvgrad\|Morvgrad]], eparquias locais). Na prática, a cadeia de comando é fluida:
...
Colaboração operacional, independência doutrinal. Ophideias acompanham [[_wiki/justiciars\|Justiciars]] como auxiliares especializadas em campo ([[_wiki/syndrith_morghast\|Syndrith]] supervisiona [[_wiki/milorsevogh_velshard\|Milor]] em [[_wiki/niedellin\|Niedellin]]), mas não estão subordinadas a eles. A relação é de cooperação pragmática: os [[_wiki/justiciars\|Justiciars]] precisam de inteligência e habilidades espectrais; as ophideias precisam de autoridade judicial para operar em territórios fora do [[_wiki/vor-ghol\|Vor-Ghol]].

A tensão latente é cultural: ophideias são [[_wiki/drul\|drul]], matriarcais, religiosas; [[_wiki/justiciars\|Justiciars]] são [[_wiki/shadar\|shadars]], independentes, seculares. Respeito mútuo coexiste com desprezo racial velado, [[_wiki/syndrith_morghast\|Syndrith]] despreza [[_wiki/orc\|orcs]] abertamente e trata [[_wiki/shadar\|shadars]] com polidez cortante.

📋 Para dados estruturais: `2.8_organizacoes_REF.tsv`.
📋 Para ficha de [[_wiki/syndrith_morghast\|Syndrith]]: §12.3 do Cânone.
📋 Para magia [[_wiki/spectro\|Spectro]]: `3.7_sistemas_magicos_LORE.md`.
